...
caffe_root = './caffe'
script_path = '.'
caffe_model = script_path + '/005_train_seg_5_anno_make_inference.prototxt'
caffe_weight = script_path + '/snapshot/005_train_seg_5_anno_iter_5500.caffemodel'
caffe_inference_weight = script_path + '/DecoupledNet_5_anno_inference.caffemodel'
