...
caffe_root = './caffe'
script_path = '.'
caffe_model = script_path + '/004_train_seg_10_anno_make_inference.prototxt'
caffe_weight = script_path + '/snapshot/004_train_seg_10_anno_iter_7500.caffemodel'
caffe_inference_weight = script_path + '/DecoupledNet_10_anno_inference.caffemodel'
